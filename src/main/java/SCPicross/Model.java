...
public class Model {
    ...
    /**
     * Tag for recieving game
     */
    protected static String recieveGameTag = "Rescieve Game";
     ...
     */
    protected static final Image diamondOre = new Image("diamondOre.png");// I know I misspelled it, I'm an idiot
     ...
     */
    protected Color cell = Color.GRAY;

    /**
     * Color for right cell
     */
    protected Color rCell = Color.GREEN;

    /**
     * Color for wrong cell
     */
    protected Color wCell = Color.RED;

    /**
     * Boolean for first stage generation
     */
    ...
    public void newGame(boolean random){
        View deView = new View(this);
        deView.updateBoard(random, false);
    }
     ...
     * @return puzzle config(solution) of new random game
     */
     ...
     * @return solution of loaded game
     * @throws IOException in case file has an error or does not exist
     */
     ...
     *               or loaded method
     * @return boolean array with solution for new game
     */
    public boolean[][] updateSolution(boolean random){
        boolean[][] arr;
        if(random){
            arr = randomGame();
    ...
    * -------SINCE ROW AND COL FOR CLUES ARE GENERATED SEPARETLY(TOP ROW OF CLUES-----------
    ...
    * -------METHODS ARE SEPARATE AS WELL-----------*/
    ...
    public void updateLanguage(int selection){
        ...
        new View(this).updateStage(Controller.getMainStage());
    }
